...
//  MamApa
//
//  Created by Singgih Tulus Makmud on 01/04/24.
//
...
struct MockData {
    ...
    static let sampleMeals: [Meal] = [
        ...
        Meal(
            ...
            imageName: "Bubur",
            preparationTime: 45,
            ingredientTags: ["Beras", "Nasi", "Daging Ayam", "Bawang Merah", "Bawang Putih", "Jahe", "Daun Bawang", "Seledri", "Telur Rebus"],
            ingredients: [
                "100 gram Beras",
        ...
        Meal(
            ...
            imageName: "Bakso",
            preparationTime: 60,
            ingredientTags: ["Daging Sapi", "Tepung Tapioka", "Tepung Terigu", "Telur", "Bawang Putih", "Bawang Merah", "Garam", "Merica", "Daun Bawang", "Kecap Manis"],
            ingredients: [
